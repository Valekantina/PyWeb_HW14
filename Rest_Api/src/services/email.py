...
async def send_email(email: EmailStr, username: str, host: str):
    ...
    The send_email function sends an email to the user with a link to confirm their email address.
        The function takes in three arguments:
            ...
            -username: this is used in both places where we need to display information about who we are sending this message to.  This will be displayed on both our template and our subject line (which should be unique).
            -host: this is used in our template body so that we can create an absolute URL for users when they click on it.
